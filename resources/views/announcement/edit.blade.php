                    ...
                    @endforeach
                            ...
                            <div class="col-lg-12 row" id="schedule_fields" style="{{ $announcement->is_schedule ? '' : 'display: none;' }}">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input type="text" id="end_at" name="end_at" class="datetime-picker form-control form-control-sm" value="{{ $announcement->end_at }}" {{ $announcement->is_schedule ? 'required' : '' }}>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea name="content" class="form-control form-control-sm" id="content">{{  $announcement->content }}</textarea>
                            </div>
