                    ...
                    <table class="table table-striped table-sm" id="myTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-primary logbtn" data-toggle="modal" data-target="#seenlog" data-action="{{$announcement->title}}" data-module="Announcements"> <i class="fas fa-eye"></i></button>
                          </td>
