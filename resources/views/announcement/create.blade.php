@extends('layouts.app') @section('title', ' Announcement') @section('css')
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <select name="branch[]" id="branch" class="form-control select2" multiple="multiple" required>
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <select name="coaching_type[]" id="coaching_type" class="select2" multiple="multiple" required>
