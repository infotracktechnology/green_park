@extends('layouts.app')
@section('title', "Phone/Sign List (Section)")
        ...
        <div class="col-md-12 col-sm-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h4>Phone/Sign List (Section)</h4>
            </div>
            <div class="card-body">
              <form method="get" action="{{ route('report.hostelsectionlist') }}">
                <div class="row">
                  ...
                  <div class="form-group  col-3">
                    ...
                    <select name="section"  class="select2" required>
                      ...
                      <option value="{{ $row }}" @selected($row==request('section'))>{{ $row }}</option>
                      @endforeach
                    </select>
                  </div>
...
<script>
  ...
  const goToMenu = (params = {}) => {
    ...
    window.location = `{{ route('report.hostelsectionlist') }}?${query}`;
  };
