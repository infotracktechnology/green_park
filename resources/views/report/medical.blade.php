@extends('layouts.app')
@section('title', "Medical Entry Report")
        ...
        <div class="col-md-12 col-sm-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h4>Medical Entry Report</h4>
            </div>
            <div class="card-body">
              <form method="get" action="{{ route('report.medical') }}">
                <div class="row">
...
<script>
  ...
  const goToMenu = (params = {}) => {
    ...
    window.location = `{{ route('report.medical') }}?${query}`;
  };
