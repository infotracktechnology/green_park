@extends('layouts.app')
@section('title', 'Student Allotment Report')
@section('css')
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          ...
          <div class="card card-primary">
            ...
            <form action="{{route('report.allotment')}}" id="myForm" method="get">
              <div class="row py-3">
                ...
                <table class="table table-striped table-sm" id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          @if(strtoupper(trim($student->hostel_dayscholar)) === 'HOSTEL')
                              <a href="{{ route('report.allotment', [
                                  'view' => 'hostel_verification',
                      ...
                      <td>
                        @if (strtoupper(trim($student->hostel_dayscholar)) === 'HOSTEL')
                         <a href="{{ route('report.allotment', ['view' => 'hostel_allotment','student_id' => $student->id]) }}"
                            class="btn btn-primary btn-sm">
                                Download
                            </a>
                        @else
