            ...
            <tbody>
                @foreach($download as $key => $download)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $branchNames = \App\Models\Branch::whereIn('id', explode(',', $download->branch))->pluck('name')->toArray();
                                                @endphp
                                                {{ implode(', ', $branchNames) }}
                                            </td>
                                            ...
                                            <td>
                                                <form action="{{ route('download.destroy', $download->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this download?')">
                                                    @csrf
                                                    @method('DELETE')
