              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-sm-12 mb-3">
                    <h6 class="col-deep-purple">Edit Download</h6>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="academic_year" id="academic_year" class="form-control form-control-sm" required>
                      ...
                      <option value="{{ $row->academic_year }}" @selected($download->academic_year == $row->academic_year)>{{ $row->academic_year }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="usertype" id="usertype" class="form-control form-control-sm" required>
                      <option value="GROUP" @selected($download->usertype == 'GROUP')>GROUP</option>
                      <option value="INDIVIDUAL" @selected($download->usertype == 'INDIVIDUAL')>INDIVIDUAL STUDENT</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="course" id="course" class="form-control form-control-sm" required>
                      ...
                      <option value="{{$row}}" @selected($row==$download->course)>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="branch[]" id="branch" class="select2" multiple required>
                      ...
                      <option value="{{ $branch->id }}" @selected(in_array($branch->id, explode(',',$download->branch)))>{{ $branch->name }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="coaching_type[]" id="coaching_type" class="select2" multiple required>
                      @foreach ($type as $row)
                      <option value="{{$row}}" @selected(in_array($row, explode(',', $download->coaching_type)))>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="category[]" id="category" class="select2" multiple>
                      ...
                      <option value="{{$row}}" @selected(in_array($row, explode(',', $download->category)))>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="batch[]" id="batch" class="select2" multiple>
                      ...
                      <option value="{{$row}}" @selected(in_array($row, explode(',', $download->batch)))>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="gender" id="gender" class="form-control form-control-sm" required>
                      ...
                      <option value="All" @selected($download->gender == 'All') >All Gender</option>
                      <option value="MALE" @selected($download->gender == 'MALE')>MALE</option>
                      <option value="FEMALE" @selected($download->gender == 'FEMALE')>FEMALE</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="section" id="section" class="form-control form-control-sm">
                      ...
                      <option value="{{ implode(',', $section)}}" @selected(implode(',', $section)==$download->section)>All</option>
                      @foreach ($section as $row)
                      <option value="{{$row}}" @selected($row==$download->section)>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <select name="students" id="students" class="form-control form-control-sm select2" required>
                      ...
                      <option value="{{$k}}" @selected($k==$download->students)>{{$k}} - {{$row}}</option>
                      @endforeach
                    </select>
                  </div>
