                  ...
                  <table class="table table-striped table-sm" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-primary logbtn" data-toggle="modal" data-target="#seenlog" data-action="{{$discussionvideo->id}}" data-module="Discussion Video"> <i class="fas fa-eye"></i></button>
                        </td>
                        <td>
