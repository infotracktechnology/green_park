...
<body>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown"> <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="message-square"></i><span>Communication</span></a>
              <ul class="dropdown-menu">
                ...
                <li><a href="{{ route('staffannouncement.index') }}" class="nav-link">Staff Announcement</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="{{ route('room.transfer') }}" class="nav-link">Room Transfer</a></li>
  ...
  <script>
    ...
    branch.change(()=>{
      ...
      var branchval = Array.isArray(branch.val()) ? branch.val().join(',') : branch.val();
      fetchData({ course: course.val(), branch: branchval })
