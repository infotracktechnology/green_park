@extends('layouts.app')
@section('title', 'Student Bulk Add')
@section('main')
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <h6 class="col-deep-purple">Student Bulk Add</h6>
                  </div>

                  <div class="col-md-6 col-sm-12 mb-3">
                    <a href="{{ env('APP_URL').'template/student_insert.csv'}}" class="btn btn-primary"><i class="fa fa-download"></i> Student Bulk Add Template Format</a>
                  </div>
