          ...
          <div class="row">
              <div class="col-12">
                  <div class="card card-primary">
                     <form method="get" id="myForm" action="{{ route('studentmenu.branch') }}" enctype="multipart/form-data">
                      <div class="card-body">
                      <div class="row">
                        ...
                        @endif
                            <h6 class="col-deep-purple">Branch Menu Assign</h6>
                        </div>
                        ...
                        <div class="form-group col-lg-3">
                            <input type="checkbox" name="fields[]" value="{{ json_encode($field) }}" @checked(in_array($field['title'], $menu_branch))> {{ $field['title'] }}
                        </div>
                        @endforeach
...
<script>
  $("#branch").on("change", function() {
    ...
    location.href = `{{ route('studentmenu.branch') }}?branch=${$(this).val()}&branch_name=${branch_name}`;
  });
