          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="row">
               ...
               <form action="{{ route('questionkey.index') }}" method="get">
                <div class="row">
              ...
              <div class="col-12">
                <form action="{{ route('questionkey.destroy','bulk') }}" method="post" onsubmit="return confirm('Are you sure you want to delete this?')">
                @csrf
                @method('DELETE')
                  ...
                  <table class="table table-striped table-sm" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('questionkey.edit', $row->id) }}" class="btn btn-primary">
