            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-2 col-sm-12 mb-3">
                  <a href="{{route('medical.create')}}" class="btn btn-primary btn-block">Add Entry</a>
                </div>
                    ...
                    <table class="table table-striped table-sm" id="myTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $entry->expense }}</td>
                          <td>
                            <a href="{{ route('medical.edit', $entry->id) }}" class="btn btn-warning text-white">
                              <i class="fas fa-edit"></i>
                            </a>
                          </td>

                          <td>
                            <form action="{{ route('medical.destroy', $entry->id) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this Entry?')">
                              @csrf
                              @method('DELETE')
