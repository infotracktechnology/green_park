         ...
         <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                   <form method="post" id="myForm" x-data="app" action="{{ route('student.update', $student->id) }}" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                    ...
                    <div class="row" x-cloak x-show="formStep === 1">
                      ...
                      <div class="form-group col-lg-3">
                        <label>Student ID</label>
                         <input type="text" name="id" value="{{$student->id}}" class="form-control form-control-sm">
                   ...
                   <div class="form-group col-lg-3">
                    ...
                    <div class="form-group col-lg-3">
                        <label>Aadhar Card No</label>
                         <input type="number" name="aadhar_card_no" value="{{$student->aadhar_card_no}}" class="form-control form-control-sm">
                    </div>
                    ...
                    <div class="form-group col-lg-3">
                        <label>Pincode</label>
                         <input type="number" name="pincode" value="{{$student->pincode}}" class="form-control form-control-sm">
                    </div>

                    <div class="form-group col-lg-3">
                        <label>Parent WhatsApp No</label>
                         <input type="number" name="parent_whatsapp_no" value="{{$student->parent_whatsapp_no}}" class="form-control form-control-sm">
                    </div>
    ...
    <input type="text" name="mother_place_of_work" value="{{$student->mother_place_of_work}}" class="form-control form-control-sm">
                      ...
                      <div class="row" x-cloak x-show="formStep === 4">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text" name="board_of_study_X_std" value="{{$student->board_of_study_X_std}}" class="form-control form-control-sm">
                        </div>
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text" name="board_of_study_XII_std" value="{{$student->board_of_study_XII_std}}" class="form-control form-control-sm">
                        </div>
                        ...
                        <div class="row" x-cloak x-show="formStep === 5">
                           ...
                           <div class="form-group col-lg-4">
                               ...
                               <input type="text" name="S1" value="{{$student->S1}}" class="form-control form-control-sm">
                           </div>
                           ...
                           <div class="form-group col-lg-4">
                               ...
                               <input type="number" name="S1_obtained_mark" value="{{$student->S1_obtained_mark}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Subject 2</label>
                               <input type="text" name="S2" value="{{$student->S2}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Maximum Marks of S2</label>
                               <input type="number" name="S2_max_marks" value="{{$student->S2_max_marks}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Marks Obtained in S2</label>
                               <input type="number" name="S2_obtained_mark" value="{{$student->S2_obtained_mark}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Subject 3</label>
                               <input type="text" name="S3" value="{{$student->S3}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Maximum Marks of S3</label>
                               <input type="number" name="S3_max_marks" value="{{$student->S3_max_marks}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Marks Obtained in S3</label>
                               <input type="number" name="S3_obtained_mark" value="{{$student->S3_obtained_mark}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Subject 4</label>
                               <input type="text" name="S4" value="{{$student->S4}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Maximum Marks of S4</label>
                               <input type="number" name="S4_max_marks" value="{{$student->S4_max_marks}}" class="form-control form-control-sm">
                           </div>

                           <div class="form-group col-lg-4">
                               <label>Marks Obtained in S4</label>
                               <input type="number" name="S4_obtained_mark" value="{{$student->S4_obtained_mark}}" class="form-control form-control-sm">
                           </div>


<div class="form-group col-lg-3">
    <label>Total Marks</label>
    <input type="number" name="total_marks" value="{{$student->total_marks}}" class="form-control form-control-sm">
</div>
               ...
               <div class="row" x-cloak x-show="formStep === 6">
                    ...
                    <div class="form-group col-lg-3">
                        ...
                        <input type="number" name="neet_score_2023" value="{{$student->neet_score_2023}}" class="form-control form-control-sm">
                    </div>
                    ...
                    <div class="form-group col-lg-3">
                        ...
                        <input type="text" name="previous_course_studied_neet" value="{{$student->previous_course_studied_neet}}" class="form-control form-control-sm">
                    </div>
    ...
    <input type="text" name="institution_bill_type" value="{{$student->institution_bill_type}}" class="form-control form-control-sm" >
                    ...
                    <div class="row">
                     <div class="col-md-3 offset-md-9 col-sm-12">
                       ...
                       <button x-cloak x-show="formStep < 6" x-on:click="updateFormStep" type="button" class="btn btn-primary">
