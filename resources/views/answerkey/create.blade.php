      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card card-primary" x-data="app">
            <form method="post" id="myForm" action="{{ route('answerkey.store') }}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-sm-12 mb-3">
                    <h6 class="col-deep-purple">Add Answer Key</h6>
                  </div>
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <input type="file" name="file[]" class="form-control form-control-sm" accept="application/pdf" multiple>
                  </div>
