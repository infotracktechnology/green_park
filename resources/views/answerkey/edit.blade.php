              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 col-sm-12 mb-3">
                    <h6 class="col-deep-purple">Edit Answer Key</h6>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="academic_year" id="academic_year" class=" form-control form-control-sm" required>
                      ...
                      <option value="{{ $row->academic_year }}" @selected($answerkey->academic_year == $row->academic_year)>{{ $row->academic_year }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="usertype" id="usertype" class="form-control form-control-sm" required>
                      <option value="GROUP" @selected($answerkey->usertype == 'GROUP')>GROUP</option>
                      <option value="INDIVIDUAL" @selected($answerkey->usertype == 'INDIVIDUAL')>INDIVIDUAL STUDENT</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="course" id="course" class="form-control form-control-sm" required>
                      ...
                      <option value="{{$row}}" @selected($row==$answerkey->course)>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-3">
                    ...
                    <select name="branch[]" id="branch" class="select2" multiple required>
                      ...
                      <option value="{{ $branch->id }}" @selected(in_array($branch->id, explode(',',$answerkey->branch)))>{{ $branch->name }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="category[]" id="category" class="select2" multiple>
                      ...
                      <option value="{{$row}}" @selected(in_array($row, explode(',', $answerkey->category)))>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="batch[]" id="batch" class="select2" multiple>
                      ...
                      <option value="{{$row}}" @selected(in_array($row, explode(',', $answerkey->batch)))>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="gender" id="gender" class="form-control form-control-sm" required>
                      ...
                      <option value="All" @selected($answerkey->gender == 'All') >All Gender</option>
                      <option value="MALE" @selected($answerkey->gender == 'MALE')>MALE</option>
                      <option value="FEMALE" @selected($answerkey->gender == 'FEMALE')>FEMALE</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select name="section" id="section" class="form-control form-control-sm">
                      ...
                      <option value="{{ implode(',', $section)}}" @selected(implode(',', $section)==$answerkey->section)>All</option>
                      @foreach ($section as $row)
                      <option value="{{$row}}" @selected($row==$answerkey->section)>{{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <select name="students" id="students" class="form-control form-control-sm select2" required>
                      ...
                      <option value="{{$k}}" @selected($k==$answerkey->students)>{{$k}} - {{$row}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-lg-12">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" name="is_schedule" class="custom-control-input" id="is_schedule" value="1" @checked($answerkey->is_schedule)>
                      <label class="custom-control-label" for="is_schedule">Is Schedule</label>
                    </div>
                  </div>

                  <div class="col-lg-12 row" id="schedule_fields" style="{{ $answerkey->is_schedule ? '' : 'display: none;' }}">
                    <div class="form-group col-lg-3">
                        <label>Start Datetime</label>
                        <input type="text" id="start_at" name="start_at" class="datetime-picker form-control form-control-sm" value="{{ $answerkey->start_at }}" {{ $answerkey->is_schedule ? 'required' : '' }}>
                    </div>

                    <div class="form-group col-lg-3">
                        <label>End Datetime</label>
                        <input type="text" id="end_at" name="end_at" class="datetime-picker form-control form-control-sm" value="{{ $answerkey->end_at }}" {{ $answerkey->is_schedule ? 'required' : '' }}>
