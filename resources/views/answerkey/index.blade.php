      ...
      <table class="table table-striped table-sm" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $key->coaching_type }}</td>
                    <td>
                        <a href="{{ env('APP_URL').$key->file_path }}" class="btn btn-primary text-white" download><i class="fas fa-download"></i></a>
                    </td>
                    
                    <td>
                        <a href="{{ route('answerkey.edit', $key->id) }}" class="btn btn-warning text-white">
                           <i class="fas fa-edit"></i>
                        </a>
                     </td>
                     <td>
                        <form action="{{route('answerkey.destroy', $key->id)}}" method="post" onsubmit="return confirm('Are you sure you want to delete this branch?')">
                           @csrf
                           @method('DELETE')
