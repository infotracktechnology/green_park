          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="row">
               ...
               <form action="{{ route('worksheet.index') }}" method="get">
                <div class="row">
                  ...
                  <table class="table table-striped table-sm" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <button type="button" class="btn btn-primary logbtn" data-toggle="modal" data-target="#seenlog" data-action="{{$worksheet->id}}" data-module="Worksheet"> <i class="fas fa-eye"></i></button>
                      </td>
