  ...
  <div class="row mb-4">
    ...
    <div class="col-md-3">
      <div class="card l-bg-purple" style="border-radius: 12px;">
        <div class="card-statistic-3">
          <div class="card-icon card-icon-large"><i class="fa fa-user-alt"></i></div>
          <div class="card-content">
            <h4 class="card-title">Boys</h4>
            <span>{{ $boys }}</span>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-3">
      <div class="card l-bg-cyan" style="border-radius: 12px;">
        <div class="card-statistic-3">
          <div class="card-icon card-icon-large"><i class="fa fa-user"></i></div>
          <div class="card-content">
