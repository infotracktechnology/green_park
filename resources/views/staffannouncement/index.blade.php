            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-10 col-sm-12 mb-3">
                  <h6 class="col-deep-purple">Staff Announcement</h6>
                </div>

                <div class="col-md-2 col-sm-6 mb-3">
                  <a href="{{route('staffannouncement.create')}}" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Add </a>
                </div>
              </div>

              <form action="{{ route('staffannouncement.index') }}" method="get">
                <div class="row">
              ...
              <div class="col-12">
                <form action="{{ route('staffannouncement.destroy','bulk') }}" method="post" onsubmit="return confirm('Are you sure you want to delete this?')">
                  @csrf
                  @method('DELETE')
                    ...
                    <table class="table table-striped table-sm" id="myTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('staffannouncement.edit', $announcement->id) }}" class="btn btn-warning text-white">
