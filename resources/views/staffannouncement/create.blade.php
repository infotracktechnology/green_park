                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4" id="staff_field" style="display: none;">
                                        ...
                                        <select name="staff[]" id="staff" class="form-control form-control-sm select2" multiple></select>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <textarea name="content" class="form-control form-control-sm" id="content" rows="4"></textarea>
                                    </div>
        ...
        staffList.forEach(function (row) {
            ...
            if (branchMatch && departmentMatch) {
                $('#staff').append(
                    $('<option>', {
                        value: row.username,
                        text: row.username + ' - ' + row.school_initial
                    })
                );
            }
        });
