...
<section class="section">
    <div class="row">
        <div class="col-12">
            <marquee behavior="scroll" direction="left" style="background-color: #e61515cb; padding: 10px; color: white; font-weight: bold;">Today is {{ date('l, F jS') }} and your upcoming class is :</marquee>
