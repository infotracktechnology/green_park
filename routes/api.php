...
Route::group(['prefix' => 'v2'], function () {
    ...
    Route::get('/examresult/{student_id}', function (Request $request, $student_id) {
        $results = DB::select("SELECT exam_date,b.name,b.testid,sum(mark)mark,(count(q_no)*4)total,b.markrange FROM `exam_answer` a join exam b on a.test_id=b.testid where student_id=$student_id and b.publish='Yes' group by b.name order by b.updated_at desc limit 5");
