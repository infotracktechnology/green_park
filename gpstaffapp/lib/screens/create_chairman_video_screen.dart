...
class CreateChairmanVideoScreen extends StatefulWidget {
  const CreateChairmanVideoScreen({super.key});

  @override
  State<CreateChairmanVideoScreen> createState() =>
      _CreateChairmanVideoScreenState();
}

class _CreateChairmanVideoScreenState extends State<CreateChairmanVideoScreen> {
        ...
        if (res.data != null && res.data['status'] == true) {
          showDialog(
            ...
            builder: (ctx) => AlertDialog(
              ...
              content: const Text('Chairman video created successfully!'),
              actions: [
                TextButton(
                  onPressed: () {
                    Navigator.pop(ctx);
  ...
  Widget build(BuildContext context) {
    ...
    if (filters.loading) {
      return Scaffold(
        ...
        appBar: AppBar(title: const Text('Add Chairman Video')),
        body: const Center(
          child: Column(
    ...
    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: AppBar(
        title: const Text('Add Chairman Video'),
      ),
