...
class _AnnouncementListScreenState extends State<AnnouncementListScreen> {
  ...
  void _showAnnouncementDetailsModal(BuildContext context, AnnouncementModel item) {
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        ...
                        if (item.isSchedule == 1 && item.startAt != null && item.startAt!.isNotEmpty) ...[
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 12),
                              _buildInfoRow('Academic Year', item.academicYear ?? 'N/A'),
                              _buildInfoRow('User Type', item.usertype == 'INDIVIDUAL' ? 'Individual Student' : 'Group Broadcast'),
                              _buildInfoRow('Course', item.course ?? 'All Courses'),
                              _buildInfoRow('Branches', item.branchDisplay),
                              _buildInfoRow('Coaching Type', item.coachingTypeDisplay),
                              if (item.category != null && item.category.toString().isNotEmpty)
                                _buildInfoRow('Category (H/D)', item.categoryDisplay),
                              if (item.batch != null && item.batch.toString().isNotEmpty)
                                _buildInfoRow('Batch', item.batchDisplay),
                              _buildInfoRow('Gender', item.gender ?? 'All'),
                              if (item.usertype == 'INDIVIDUAL')
                                _buildInfoRow('Target Student', item.students?.toString() ?? 'N/A')
                              else
                                _buildInfoRow('Section', (item.section == null || item.section!.isEmpty) ? 'All Sections' : item.section!),
                            ],
                          ),
                        ),
                        const SizedBox(height: 18),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              const Row(
                                children: [
                                  Icon(Icons.notes, size: 16, color: AppColors.fanta),
                                  SizedBox(width: 6),
                                  Text(
                                    'MESSAGE CONTENT',
                                    style: TextStyle(
                              ...
                              SelectableText(
                                item.cleanContent.isNotEmpty ? item.cleanContent : 'No content body provided.',
                                style: const TextStyle(
                                  fontSize: 14,
                                  color: AppColors.textPrimary,
                                  height: 1.5,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    const Icon(Icons.attachment, size: 16, color: AppColors.primary),
                                ...
                                ListView.separated(
                                  ...
                                  itemBuilder: (context, idx) {
                                    ...
                                    final fileName = AnnouncementModel.getAttachmentFileName(path);
                                              ...
                                              if (item.attachments.isNotEmpty) ...[
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      const Icon(Icons.attach_file, size: 11, color: AppColors.primary),
