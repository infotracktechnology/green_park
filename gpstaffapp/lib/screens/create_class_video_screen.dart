...
class CreateClassVideoScreen extends StatefulWidget {
  const CreateClassVideoScreen({super.key});

  @override
  State<CreateClassVideoScreen> createState() => _CreateClassVideoScreenState();
}

class _CreateClassVideoScreenState extends State<CreateClassVideoScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      formData.fields.add(MapEntry('chapter', chapter));
      formData.fields.add(MapEntry('period', _selectedPeriod));
        ...
        if (res.data != null && res.data['status'] == true) {
          showDialog(
            ...
            builder: (ctx) => AlertDialog(
              ...
              content: const Text('Class video created successfully!'),
              actions: [
                TextButton(
                  onPressed: () {
                    Navigator.pop(ctx);
  ...
  Widget build(BuildContext context) {
    ...
    if (filters.loading) {
      return Scaffold(
        ...
        appBar: AppBar(title: const Text('Add Class Video')),
        body: const Center(
          child: Column(
    ...
    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: AppBar(
        title: const Text('Add Class Video'),
      ),
