...
class EditQuestionKeyScreen extends StatefulWidget {
  final dynamic keyId;
  const EditQuestionKeyScreen({super.key, required this.keyId});

  @override
  State<EditQuestionKeyScreen> createState() => _EditQuestionKeyScreenState();
}

class _EditQuestionKeyScreenState extends State<EditQuestionKeyScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final res = await dio.get('/admin/questionkey/${widget.keyId}/edit');
      if (res.data != null && res.data['status'] == true) {
        final data = res.data['questionkey'] as Map<String, dynamic>;
        final model = QuestionKeyModel.fromJson(data);
      ...
      debugPrint('Edit question key fetch error: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('Failed to load question paper details'),
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      final res = await dio.post(
          '/admin/questionkey/${widget.keyId}?_method=PUT',
          data: formData,
        ...
        if (res.data != null && res.data['status'] == true) {
          showDialog(
              ...
              builder: (ctx) => AlertDialog(
                      ...
                      content:
                          const Text('Question paper updated successfully!'),
                      actions: [
                        TextButton(
                            onPressed: () {
                              Navigator.pop(ctx);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (filters.showSection) const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    ...
    if (_fetching || filters.loading) {
      return Scaffold(
          ...
          appBar: AppBar(title: const Text('Edit Question Paper')),
          body: const Center(
              child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
              ...
              if (_existingFiles.isNotEmpty) ...[
                ...
                ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      final filePath = _existingFiles[index];
                      ...
                      return Container(
                          ...
                          child: Row(children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () => _removeExisting(index))
                          ]));
                    }),
